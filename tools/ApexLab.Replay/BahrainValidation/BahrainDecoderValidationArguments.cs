...
internal sealed record BahrainDecoderValidationArguments(
    string DataRoot,
    RawEvidenceCaptureId CaptureId)
{
    public static bool TryParse(
        IReadOnlyList<string> arguments,
        [NotNullWhen(true)] out BahrainDecoderValidationArguments? parsed)
    {
        parsed = null;
        ...
        parsed = new BahrainDecoderValidationArguments(dataRoot, captureId);
        return true;
    }
